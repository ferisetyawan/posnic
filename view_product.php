...
<head>
    ...
    <script LANGUAGE="JavaScript">
        ...
        function confirmSubmit() {
            var agree = confirm("Apakah Anda Yakin Untuk Menghapus Data Ini?");
            if (agree)
                return true;
            else
                return false;
        ...
        function confirmDeleteSubmit() {
            ...
            if (flag < 1) {
                alert("Anda harus memeriksa satu dan hanya satu kotak centang!");
                return false;
            } else {
                var agree = confirm("Apakah Anda Yakin Menghapus data yang dipilih?");
                if (agree)
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#form1").validate({
                ...
                messages: {
                    name: {
                        required: "Silahkan isi nama supplier",
                        minlength: "supplier harus terdiri dari minimal 3 karakter"
                    },
                    address: {
                        minlength: "Alamat supplier harus minimal 3 karakter",
                        maxlength: "Alamat supplier harus minimal 3 karakter"
                    }
                }
            });
